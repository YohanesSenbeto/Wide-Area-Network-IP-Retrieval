          ...
          <div className="auto-container">
            <div className="inner-container">
              <div className="left-column">
                <div className="text">Retrieve Your WAN IP information easly</div>
              ...
              <div className="right-column">
                {isLogged ? (
                  ...
                  <div className="phone-number">For more support call us on : <strong>+251911151511 </strong> </div>
                )}
              </div>
            </div>
          </div>
                  ...
                  <nav className="main-menu navbar-expand-md navbar-light">
                    <div className="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                      <ul className="navigation">
                        ...
                        <li><a href="/wanip">WAN IP</a></li>
                        <li><a href="/blog">Blog</a></li>
                        <li><a href="/tutorials">Tutorials</a></li>
                        <li><a href="/support">Support</a></li>
                        <li><a href="/contact">Contact Us</a></li>
                        <li><a href="/adminarea">Admin Area</a></li>
